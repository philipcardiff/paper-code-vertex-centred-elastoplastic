...
Transfinite Curve {13} = cn+1 Using Progression 1;
Transfinite Curve {13, 14, 25, 26, 17, 20, 15, 22, 27} = cn/2 + 1 Using Progression 1;
Transfinite Curve {23, 16, 19} = (cn+1) + cn Using Progression 1;
Transfinite Curve {21, 24, 18} = cn/2 + 1 Using Progression 1;
